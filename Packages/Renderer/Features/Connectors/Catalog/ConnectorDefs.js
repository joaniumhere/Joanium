...
export const STATIC_CONNECTORS = [
  {
    ...
    automations: [
      { name: 'Morning Briefing', description: 'Daily — summarize emails, calendar, and Drive changes' },
      { name: 'Meeting Prep', description: 'Before meetings — pull agenda from Calendar + related Drive docs' },
    ],
  },
  {
    id: 'github',
...
export const STATIC_FREE_CONNECTORS = [
  ...
  { id: 'ipgeo', name: 'IP Geolocation', icon: '🌍', description: 'Look up geolocation, ISP, and timezone info for any IP address.', noKey: true, docsUrl: 'https://ip-api.com', toolHint: 'Ask: "What\'s my IP location?"' },
  { id: 'funfacts', name: 'Fun Facts & Trivia', icon: '🎲', description: 'Random fun facts, number trivia, math facts, and date facts.', noKey: true, docsUrl: 'https://uselessfacts.jsph.pl', toolHint: 'Ask: "Give me a random fact"' },
  { id: 'jokeapi', name: 'Jokes', icon: '😂', description: 'Random jokes — programming, puns, misc, and more.', noKey: true, docsUrl: 'https://v2.jokeapi.dev', toolHint: 'Ask: "Tell me a joke"' },
  { id: 'quotes', name: 'Quotes', icon: '💬', description: 'Inspirational and thought-provoking quotes.', noKey: true, docsUrl: 'https://zenquotes.io', toolHint: 'Ask: "Give me an inspirational quote"' },
  { id: 'restcountries', name: 'Country Info', icon: '🌐', description: 'Detailed country data — capital, population, languages, currencies, and more.', noKey: true, docsUrl: 'https://restcountries.com', toolHint: 'Ask: "Tell me about Japan"' },
  { id: 'nasa', name: 'NASA / Astronomy', icon: '🔭', description: 'NASA Astronomy Picture of the Day and real-time ISS tracking.', noKey: false, optionalKey: true, keyLabel: 'NASA API Key', keyPlaceholder: 'api.nasa.gov', keyHint: 'Free key with 1,000 req/hr. Works without key (30/hr).', docsUrl: 'https://api.nasa.gov', toolHint: 'Ask: "Show me NASA\'s picture of the day"' },
