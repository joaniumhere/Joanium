export const FINANCE_TOOLS = [
  {
    ...
    description:
      'Get real-time currency exchange rates for 160+ currencies. Convert between any two currencies.',
  ...
  },
  {
    ...
    description:
      'Get official US Treasury financial data — national debt, average interest rates, or daily cash balance from fiscaldata.treasury.gov.',
    category: 'treasury',
    parameters: {
      type: {
        type: 'string',
  ...
  },
  {
    name: 'get_fred_data',
    description:
      'Get economic data from the Federal Reserve (FRED). Covers GDP, unemployment rate, CPI/inflation, federal funds rate, and hundreds of other indicators.',
    category: 'fred',
    parameters: {
      series_id: {
        type: 'string',
