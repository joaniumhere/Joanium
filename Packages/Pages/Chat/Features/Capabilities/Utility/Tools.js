export const UTILITY_TOOLS = [
  {
    ...
    description:
      'Evaluate a math expression with parentheses, exponentiation, constants like pi/e, and functions such as sqrt, abs, round, floor, ceil, sin, cos, tan, log, ln, and exp.',
    category: 'utility',
    parameters: {
      expression: {
        type: 'string',
  ...
  },
  {
    ...
    description:
      'Show the current date and time in any IANA timezone such as "Asia/Kolkata", "America/New_York", or "Europe/London".',
    category: 'utility',
    parameters: {
      timezone: {
        type: 'string',
