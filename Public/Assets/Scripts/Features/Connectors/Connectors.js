...
const FREE_CONNECTORS = [
  ...
  },
  {
    ...
    name:        'Dictionary',
    icon:        '📖',
    description: 'English word definitions, phonetics, synonyms, antonyms, and usage examples.',
    noKey:       true,
    docsUrl:     'https://dictionaryapi.dev',
    tools:       ['define_word'],
    toolHint:    'Ask: "Define serendipity" or "What does ephemeral mean?"',
  },
  {
    id:          'newsdata',
    name:        'News',
    icon:        '📰',
    description: 'Latest news headlines by keyword, category, or country. Works without a key via Google News RSS; add a Newsdata.io key for better results.',
    noKey:       false,
    optionalKey: true,
    keyLabel:    'Newsdata.io API Key',
    keyPlaceholder: 'Get your free key at newsdata.io',
    keyHint:     'Register at newsdata.io — free tier: 200 requests/day. Works without a key using Google News.',
    docsUrl:     'https://newsdata.io',
    tools:       ['get_news'],
    toolHint:    'Ask: "Latest AI news" or "What\'s happening in technology?" or "News from India"',
  },
  {
    id:          'ipgeo',
    name:        'IP Geolocation',
